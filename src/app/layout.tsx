...
export default function RootLayout({
  ...
  <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
    <a><svg xmlns="http://www.w3.org/2000/svg" width="24" height="12" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
  </nav>
            </header>
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
        <li><a className = "btn btn-white">Home</a></li>
        <li>
          <a>Services</a>
          <ul className="p-2">
    ...
    <a className="btn btn-white text-xl">ProWash of the GrandStrand</a>
  </div>
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1">
      ...
      <li>
        <details>
          <summary className = "btn btn-white">Services</summary>
          <ul className = "btn btn-white p-2">
          <li><a>House Washing</a></li>
            <li><a>Concrete Cleaning </a></li>
            <li><a>Patio & Deck Cleaning</a></li>
            <li><a>Commercial Services</a></li>
      ...
      <li><a className = "btn btn-white">Get a Fast Quote</a></li>
    </ul>
  </div>
