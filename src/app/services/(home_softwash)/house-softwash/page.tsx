          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-lg leading-8">Invest in Your Property Value - This is especially important if you plan on selling your home within the next year. By having your house clean will show potential buyers the home has been taken care of and will result in more money for you when you sell it. </p>
              </div>
            </div>
            <Image
              src="/prowash5.jpg"
      ...
      <div className="bg-white rounded-t-3xl py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <h3 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">The Importance of a Clean and Attractive Home</h3>
          </div>
