      ...
      <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
        ...
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            ...
            <h3>A Gentle Removal of Debris</h3>
          </dt>
          <dd className="mt-2 text-base leading-7 text-gray-600">The best and easiest way to remove mold, mildew, dirt and unnecessary debris is by pressure washing the area. This is a gentle removal that in many cases only requires water. Pressure washing will lift the dirt, mold and mildew from the surface without causing damage to the material. For tough and difficult stains a safe and environmentally friendly cleaning agent may need to be applied. </dd>
        </div>
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
          ...
          <dd className="mt-2 text-base leading-7 text-gray-600">ProWash of the GrandStrand will remove the dirt, grime and scattered tree leaves that causes mold and mildew. This is important because dirt, mold, and mildew can cause wooden boards to become rotted, and for concrete to weaken and crack and chip away.</dd>
        </div>
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
