...
<h1 className="mt-2 text-xl font-bold tracking-tight ">Pressure Washing Apartment Buildings</h1>
</div>
    ...
    <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
      <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
        <div className="relative pl-16">
          ...
          <dd className="mt-2 text-base leading-7 text-gray-600">From breezeway cleaning to pool deck cleaning, we cover it all. For an existing or prospective tenant, every part of your property counts. We deliver the best with our full-service pressure washing solutions.</dd>
        </div>
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
          ...
          <dd className="mt-2 text-base leading-7 text-gray-600">Curb appeal starts with clean siding. Our gentle washing and pressure washing solutions are a safe way to remove mold, mildew, dirt, and other imperfections from your exterior. Your first impression will shine - and new and potential tenants will be impressed.</dd>
        </div>
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
          ...
          <dd className="mt-2 text-base leading-7 text-gray-600">When so much of your exterior is comprised of concrete surfaces, maintenance counts. Our pressure washing solution strips away dirt, grease, chewing gum, oil, and more. We clean your:​</dd>
          <ul className="list-disc list-inside  mt-2 text-base leading-7 text-gray-600">
        <li>Walkways</li>
        <li>Parking Lots & Curbs</li>
        <li>Office Entryways</li>
        <li>Pool Decks</li>
        <li>Breezeways</li>
        <li>Patios</li>
        <li>And more!</li>
