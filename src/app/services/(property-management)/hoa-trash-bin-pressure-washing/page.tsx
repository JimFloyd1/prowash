...
<h1 className="mt-2 text-xl font-bold tracking-tight ">HOA Trash Bin Cleaning</h1>
</div>
...
Trash Bin Cleaning for HOA's</h2>
      ...
      <ul className="list-disc list-inside  mt-2 text-base leading-7">
        <li>We wash, sanitize, and maintain trash bins so your residents don’t have to.</li>
      ...
      <p className="mt-6 text-lg leading-8">Provide your residents’ with a healthier community. We understand the importance of keeping a neat and clean neighborhood and the significance this has on the health and safety of your residents. Dirty trash bins can pose potential health risks; not to mention the eyesore and terrible odors that come along with them. Maintain that clean curb appeal your strive for, while reducing unpleasant odors and preventing health risks that arise from bacteria, pests and mosquitoes.</p>
    </div>
  </div>
  <Image
    src="/prowash5.jpg"
      ...
      <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
        ...
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            ...
            <h3>Comprehensive trash bin cleaning and sanitization services</h3>
          </dt>
          <dd className="mt-2 text-base leading-7 text-gray-600">What Do We Do? - At ProWash Pressure Washing, we wash, sanitize, and maintain trash bins so your residents don’t have to. Using high-pressure hot water washes, we leave bins squeaky clean and deodorized, making them smell brand-new. This comprehensive cleaning process kills 99.9% of germs, fungi, and viruses, helping to maintain a hygienic environment.</dd>
        </div>
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
        ...
        <div className="relative pl-16">
          ...
          <h3>Enhance curb appeal and reduce health risks</h3>
          </dt>
          <dd className="mt-2 text-base leading-7 text-gray-600">Maintain Curb Appeal and Reduce Health Risks - Providing residents with a cleaner community enhances curb appeal and reduces unpleasant odors. Regular cleaning and sanitizing of trash bins prevent health risks associated with bacteria, pests, and mosquitoes. By maintaining clean trash bins, ProWash Pressure Washing helps create a safer and more attractive neighborhood for all residents. </dd>
        </div>
      </dl>
    </div>
  </div>
