...
<h1 className="mt-2 text-xl font-bold tracking-tight ">Pressure Washing Townhouse & Condo Communities</h1>
</div>
    ...
    <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
      <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
        ...
        <div className="relative pl-16">
          ...
          <h3>Trust the local experts with decades of experience</h3>
          </dt>
          <dd className="mt-2 text-base leading-7 text-gray-600">Experienced Local Experts - ProWash Pressure Washing has been serving Myrtle Beach and surrounding areas for over 30 years. Our extensive experience, knowledge, and best methods guarantee the safe and effective cleaning of your property. Contact us at 843-457-8440 or online for more information and a free quote, and see how we can make your community stand out positively. </dd>
        </div>
      </dl>
    </div>
  </div>
