...
<li className="flex space-x-2 rtl:space-x-reverse items-center pb-6">
            ...
            <span className="leading-tight">House Exterior Walls Pressure Washed with Gentle Pressure, Safe & Eco-Friendly Soap & Cleaning Agents, Not Harmful to Plants, Flowers or Children</span>
        </li>
        <li className="flex space-x-2 rtl:space-x-reverse items-center pb-6">
            <svg className="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
            </svg>
            <span className="leading-tight">All House Trim, Windows, Soffits, Doors, Gutters, Garage Doors will be Pressure Washed</span>
        </li>
        <li className="flex space-x-2 rtl:space-x-reverse items-center pb-6">
            <svg className="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
            </svg>
            <span className="leading-tight">All Porches, Driveways Walkways, and Entranceway areas will be pressure washed​</span>
        </li>
        <li className="flex space-x-2 rtl:space-x-reverse items-center pb-6">
            <svg className="flex-shrink-0 w-3.5 h-3.5 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
            </svg>
            <span className="leading-tight pb-6">Patio & Deck Pressure Washing, Brick & Concrete Cleaning, Pavers & Tile Cleaning</span>
        </li>
